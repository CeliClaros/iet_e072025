...
BOTON CERRAR Y MINIMIZAR > LO SACAMOS!! -->
        ...
        <div class="box-body">
         <!--
         <form role="form" action="insertar-user.php">  -->  
       <!--  <form role="form" name="crear-admin" id="crear-admin" method="GET" action="insertar-admin.php">  -->

          <form role="form" name="crear-admin" id="crear-admin" action="insertar-user.php">  
