        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Administra Eventos Reservados</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<!--     SI SACO EL WHILE LA TABLA APARECE VACIA  -->
                    ...
                    <!--   <td> <?php //echo $reservas['tramite_id']; ?></td>  -->
                      ...
                      <td> <?php echo $reservas['status']; ?></td>
                       ...
                       <td>
                            <a href="editar-evento.php?id=<?php echo $reservas['id_registrado']; ?>" class="btn bg-orange btn-flat margin">

                              <i class= "fa fa-pencil"></i>
                            </a>  

                            <a href="#" data-id="<?php echo $reservas['id_registrado'] ?>" data-tipo="admin" class="btn bg-maroon btn-flag margin borrar-registro" >
