  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Editar datos de usuario Administrador aquí</small>
      </h1>
...
BOTON CERRAR Y MINIMIZAR > LO SACAMOS!! -->
        ...
        <div class="box-body">
            ...
            <?php 
                 ...
                 $sql = "SELECT * FROM admin_users WHERE id_admin = $id ";
        ...
        <!--   <form role="form" name="crear-admin" id="crear-admin"  action="insertar-admin.php">  -->
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre Usuario" value="  <?php echo $admin['nombre']; ?>   "   >
                </div>
