      ...
      <div class="programa-evento">
        ...
        <nav class="menu-programa">
          ...
          while ($lista_categoria = mysqli_fetch_assoc($lista_categoria_sql)) {
            ...
            <a href="#talleres"><i class="<?php echo $lista_categoria['icono']; ?>" aria-hidden="true"></i>
      ...
      */
        ...
        <div id="talleres" class="info-curso ocultar clearfix">
          <div class="detalle-evento">
            ...
            <p>
              <i><?php echo $tram = tramite($tipo_tramite, $un_evento['tramite']); //DEBERA TRAER NOMBRE TRAMITE Y NOMBRE TIPO TRAM DESDE FUNCION TRAMITE.- ?></i>
            </p>
            ...
            <p><i class="fas fa-user" aria-hidden="true"></i>
              <?php echo $listar_rta['nombre'] . " " . $listar_rta['apellido']; ?> </p>
          </div>
