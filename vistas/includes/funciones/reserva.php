...
//echo "Entro pòr reserva!!";
			...
			//	echo "<br> TRAMITE : " . $_GET['tramites'][0];		//comentado 17/dic/2024


			//echo "LLEGA???:    ". $tram=$_GET['reserva']; //[0];		//comentado 17/dic/2024
...
//-------------------
//COMMENT: 08/MAYO/2025
//header("Location: /../selecciona_envia.php?ok&id&last=$last"); 		
//-----------------
...
header("Location:/../vistas/selecciona_envia.php?ok");
