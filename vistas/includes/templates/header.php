...
-->
      ...
      <div class="clearfix">
        <p class="fecha"><i class="far fa-calendar-alt"></i> <?php date_default_timezone_set("America/Argentina/Buenos_Aires"); echo date("d-M");  // setlocale(LC_ALL,"es_ES"); echo date("d-M");          // date_default_timezone_set("Asia/Bangkok");   //setlocale(LC_ALL,"es_ES"); echo date("d-M");  //echo TODAY() ?> </p> <!--10-12-Dic</p>  -->
